...
class FilterCommunityAdapter : RecyclerView.Adapter<FilterCommunityAdapter.FilterViewHolder>() {
...
//    var onItemClick: ((FilterDomainOptionEntity) -> Unit)? = null
    ...
    fun submitData(filterList: List<FilterDomainEntity>) {
        list.clear()
        this.list = filterList.toMutableList()
        notifyDataSetChanged()
    }

    fun getListOfSelectedCommunity(): ArrayList<String> {
